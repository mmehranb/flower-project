...
export class DatePickerComponent
  implements OnChanges, OnInit, AfterViewInit, ControlValueAccessor, Validator, OnDestroy {
  isInitialized: boolean = false;
  @Input() form?: FormGroup;
  @Input() formCtrlName: String;
  @Input() handleValidation: String;
  ...
  set selected(selected: Moment[]) {
    ...
    this.inputElementValue = (<string[]>(
      this.utilsService.convertFromMomentArray(
    ...
    this.form.controls[`${this.formCtrlName}`].patchValue(this.inputElementValue);
  ...
  setInputElementContainer() {
    this.inputElementContainer =
      this.utilsService.getNativeElement(this.componentConfig.inputElementContainer) ||
  ...
  init() {
    ...
    this.currentDateView = this.displayDate
      ? this.utilsService
          .convertToMoment(this.displayDate, this.componentConfig.format, this.componentConfig.locale)
          .clone()
      : this.utilsService.getDefaultDisplayDate(
          this.currentDateView,
          this.selected,
  ...
  onViewDateChange(value: CalendarValue) {
    let strVal = value
      ? this.utilsService.convertToString(value, this.componentConfig.format, this.componentConfig.locale)
      : "";
